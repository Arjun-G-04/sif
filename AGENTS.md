...
- Database: Drizzle. Schema in `src/db/schema.ts`. Use camelCase in TS, snake_case in database. Never edit or review migration files in `drizzle/` (auto-generated).
